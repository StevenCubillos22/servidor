...
class Biblioteca {
            ...
            if ($result = $this->db->query("SELECT * FROM libros
                ...
                if ($result->num_rows != 0) {
                    ...
                    if ($resultAutores !== false){
                        ...
                        echo "<td>" . $libro->get_genero() . "</td>";
                        echo "<td>" . $libro->get_numPaginas() . "</td>";
                        echo "<td>" . $libro->get_autores() . "</td>";
                        
                        echo "<td><a href='index.php?action=formularioModificarLibro&idLibro=" . $libro->get_idLibro() . "'>Modificar</a></td>";
                        echo "<td><a href='index.php?action=borrarLibro&idLibro=" . $libro->get_idLibro() . "'>Borrar</a></td>";
                        echo "</tr>";
                    }
                    echo "</table>";
                } else {
        ...
        public function formularioInsertarLibros()      
        {
            ...
            while ($fila = $result->fetch_object("Autor")) { //Autor
                echo "<option value='" . $fila->get_idPersona() . "'>" . $fila->get_nombre() . " " . $fila->get_apellido() . "</option>";
            }                           //idPersona
            echo "</select>";
        ...
        public function insertarLibro()
        {
            ...
            $this->db->query("INSERT INTO libros (titulo,genero,pais,año,numPaginas) VALUES ('$titulo','$genero', '$pais', '$año', '$numPaginas')");
        ...
        public function formularioModificarLibro()
        {
            ...
            echo "<form action = 'index.php' method = 'get'>
                    ...
                    Título:<input type='text' name='titulo' value='" . $libro->get_titulo() . "'><br>
                    Género:<input type='text' name='genero' value='" . $libro->get_genero() . "'><br>
                    País:<input type='text' name='pais' value='" . $libro->get_pais() . "'><br>
                    Año:<input type='text' name='año' value='" . $libro->get_año() . "'><br>
                    Número de páginas:<input type='text' name='numPaginas' value='" . $libro->get_numPaginas() . "'><br>";
            ...
            while ($autor = $autoresLibro->fetch_object("Autor")) {
                $listaAutoresLibro[] = $autor->get_idPersona();
            }
            ...
            while ($fila = $todosLosAutores->fetch_object("Autor")) {
                ...
                echo "<option value='" . $fila->get_idPersona() . " selected'>" . $fila->get_nombre() . " " . $fila->get_apellido() . "</option>"; //echo "<option value='" . $fila->get_idPersona() . "'>" . $fila->get_nombre() . " " . $fila->get_apellido() . "</option>";
                else
                echo "<option value='" . $fila->get_idPersona() . "'>" . $fila->get_nombre() . " " . $fila->get_apellido() . "</option>";;
            }
            echo "</select>";
