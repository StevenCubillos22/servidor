...
class Estudiante {
    ...
    public function __construct($nombre, $edad, $curso, $notasArr){
        $this->nombre = $nombre;
        $this->edad = $edad;
        $this->curso = $curso;
    ...
    function __toString() {
        return "<br>Nombre: " . $this->nombre . "<br> Edad: " . $this->edad . "<br> curso: " . $this->curso . "<br> Media de notas: " . $this->obtenerMedia() . " - ";
    }
